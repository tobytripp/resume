...
\item \emph{Fast, dependable, automated tests} that quickly direct the
  developer to the source of any problem as well as document the
  system.
\item \emph{Automated build and deployment} for rapid cycles between
  feature conception and feature delivery.
...
\cvitemwithcomment{Professional}{\small Ada, Clojure, Perl, Tcl/Tk, Php, Soar}
{\tiny also Awk and Ksh, but that's a story\ldots}
\cvitemwithcomment{Hobbyist}{\small Prolog, Haskell}{}

\section{Experience}

%\cventry{year--year}{Degree}{Institution}{City}{\textit{Grade}}{Description}

\cventry {December 2010--\\Present} {Senior Developer} {Backstop
